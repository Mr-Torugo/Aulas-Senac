      ...
      <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-1/3">
          <img
            ...
            alt="Homem-Aranha: Através do Aranhaverso"
        ...
        <div class="w-full lg:w-2/3 flex flex-col justify-between">
          <div>
            ...
            <p class="text-gray-400 text-sm mb-4 flex items-center">
              <i class="fas fa-calendar-alt mr-2 text-red-400"></i> Estreia: 13
              de dezembro de 2022
            </p>
            ...
            <p class="text-gray-300 mb-6 leading-relaxed">
              ...
              através de múltiplos universos.
            </p>
      ...
      <div class="mt-12">
        ...
        <div class="aspect-w-16 aspect-h-9">
          <iframe
            ...
            title="Trailer Homem-Aranha: Através do Aranhaverso"
            frameborder="0"
            allowfullscreen
          ></iframe>
        </div>
