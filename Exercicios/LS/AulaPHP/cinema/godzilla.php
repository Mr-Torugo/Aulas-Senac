      ...
      <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-1/3">
          <img
            ...
            alt="Godzilla e Kong: O Novo Império"
        ...
        <div class="w-full lg:w-2/3 flex flex-col justify-between">
          <div>
            ...
            <p class="text-gray-400 text-sm mb-4 flex items-center">
              <i class="fas fa-calendar-alt mr-2 text-red-400"></i> Estreia: 15
              de Março de 2024
            </p>
            <div class="flex flex-wrap gap-2 mb-4">
              <span
                class="genre-tag text-xs bg-green-900/50 text-green-300 px-3 py-1 rounded-full"
                >Ação</span
              >
              <span
                class="genre-tag text-xs bg-gray-900/50 text-gray-300 px-3 py-1 rounded-full"
          ...
          <div class="mt-8">
            ...
            <div class="flex items-center">
              <div
                class="rating-circle bg-green-600 text-white w-12 h-12 flex items-center justify-center rounded-full text-lg font-bold"
              >
                7.1
              </div>
              <span class="ml-4 text-gray-400 text-sm"
                >Baseado em milhares de votos</span
              >
            </div>
          </div>
        </div>
      ...
      <div class="mt-12">
        ...
        <div class="aspect-w-16 aspect-h-9">
          <iframe
            ...
            height="400"
            src="https://www.youtube.com/embed/va-7FEpUHVQ"
            title="Trailer Godzilla e Kong: O Novo Império"
            frameborder="0"
            allowfullscreen
          ></iframe>
        </div>
